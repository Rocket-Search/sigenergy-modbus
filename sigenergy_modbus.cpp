//compile	#g++ -g -O3 -fPIC -Wall -std=c++20 -fpermissive -c -o sigenergy_modbus.o sigenergy_modbus.cpp; 
//link		#g++ -O3 -fPIC -Wall -o sigenergy_modbus sigenergy_modbus.o -lmodbus;
	...
	for (int i = 1; i < config_zeile.size(); i++)
	{
		...
		if (register_data_type == "S32")
		{
			...
			for (int i=0; i < rc; i++) 
			{
				...
				cout<<register_beschreibung<<"#"<<tab_reg_s32[i]<<"#"<<endl;
